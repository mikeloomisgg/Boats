...
public class SpriteTimeline : ISTE
{
	...
	public void SetupRects()
	{
		...
		durationLabel = new Rect(330, 30, 60, 20);
		durationRect = new Rect(384, 30, 40, 20);
		previewButtonRect = new Rect(426, 30, 60, 20);
		staticTexRect = new Rect(15, 55, 200, 20);
#endif
	}
	...
	*/
	...
	void AddAnimation()
	{
		...
		((PackedSprite)sprite).textureAnimations = new TextureAnim[sprite.States.Length + 1];
